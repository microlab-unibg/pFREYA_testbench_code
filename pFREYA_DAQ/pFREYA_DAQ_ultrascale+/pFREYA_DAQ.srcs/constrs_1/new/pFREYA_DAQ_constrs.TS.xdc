...
set_property PACKAGE_PIN F13 [get_ports dac_cs]
set_property PACKAGE_PIN F14 [get_ports dac_sck]
set_property PACKAGE_PIN J14 [get_ports dac_sdin]
...
set_property SLEW SLOW [get_ports dac_cs]
...
set_property SLEW SLOW [get_ports led_error]
...
set_property DRIVE 8 [get_ports dac_cs]
...
connect_debug_port u_ila_0/probe5 [get_nets [list dac_cs_OBUF]]
create_debug_port u_ila_0 probe
