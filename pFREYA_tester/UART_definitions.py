# UART parameters
COM_PORT = 'COM5' # COM4 on the other pc
BAUD_RATE = 115200
...
DAC_PACKET_LENGTH  = 16   # 16 bit
 
DAC_UART_DATA_POS = 5

#DAC_UART_DATA_LAST_POS = 5
DAC_UART_DATA_LAST_POS = 3   
...
SEND_DAC_CMD        = '1000'   # for sending the DAC config (CS1)
SEND_DAC_CS2_CMD    = '1100'   # for sending the DAC config (CS2)
